...
APP = readpdf
CLEAN = $(APP) pdf.c pdf_parse.o readpdf.o tst.o dict.o pdfindex.o pdfmem.o substream.o
...
readpdf : pdf_parse.o readpdf.o tst.o dict.o pdfindex.o pdfmem.o substream.o $(TGT_LIB) $(LIB_CRYPTO)
